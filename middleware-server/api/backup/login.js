...
module.exports = (app, storeName, domainName, apiKey, apiToken) => {
  ...
  app.get('/api/authentication/start', (req, res) => {
    ...
    let urlvtex = 'https://' + domainName + '/api/vtexid/pub/authentication/start?callbackUrl=https%3A%2F%2F' + domainName + '%2Fapi%2Fvtexid%2Fpub%2Fauthentication%2Ffinish&scope=' + storeName + '&user=&locale=es-MX&accountName=&returnUrl=%252F&appStart=true'
                  //'https://' + domainName + '/api/vtexid/pub/authentication/start?callbackUrl=https%3A%2F%2F' + domainName + '%2Fapi%2Fvtexid%2Fpub%2Fauthentication%2Ffinish&scope=' + storeName + '&user=&locale=en-US&accountName=&returnUrl=%252F&appStart=true';
                  //https://www.elektra.com.mx/api/vtexid/pub/authentication/start?callbackUrl=https%3A%2F%2Fwww.elektra.com.mx%2Fapi%2Fvtexid%2Fpub%2Fauthentication%2Ffinish&scope=elektra&user=&locale=en-US&accountName=&returnUrl=https%253A%252F%252Fwww.elektra.com.mxhttps%253A%252F%252Fwww.elektra.com.mx%252Fadmin&appStart=true',
    let resobj;
